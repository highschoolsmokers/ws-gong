            ...
            <section className="grid grid-cols-1 md:grid-cols-[1fr_2fr] gap-6 md:gap-12 border-t border-black pt-8 pb-10">
              ...
              <div className="text-sm leading-relaxed space-y-4">
                <p>
                  ...
                  existence. Nonetheless it was founded with the idea of
                  creating a &lsquo;total&rsquo; work of art in which all arts,
            ...
            <section className="grid grid-cols-1 md:grid-cols-[1fr_2fr] gap-6 md:gap-12 border-t border-black pt-8 pb-10">
              ...
              <div className="text-sm leading-relaxed space-y-4">
                <p>
                  ...
                  objectivity. Hallmarks of the style are asymmetric layouts,
                  use of a grid, sans-serif typefaces like Akzidenz Grotesk, and
            ...
            <section className="grid grid-cols-1 md:grid-cols-[1fr_2fr] gap-6 md:gap-12 border-t border-black pt-8 pb-10">
              ...
              <div className="text-sm leading-relaxed space-y-4">
                <p>
                  ...
                  graphic designers, who produced their advertising and
                  technical literature. These pioneering graphic artists saw
                  design as part of industrial production and searched for
                  anonymous, objective visual communication. They chose
                  photographic images rather than illustration, and typefaces
                  that were industrial-looking rather than those designed for
                  books.
                </p>
              </div>
            </section>
