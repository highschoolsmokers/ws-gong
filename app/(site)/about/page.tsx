...
export default function About() {
  return (
    <div className="space-y-0">
      <section className="grid grid-cols-1 md:grid-cols-[1fr_2fr] gap-6 md:gap-12 border-t border-black pt-8 pb-10">
        ...
        <div className="space-y-4 text-sm leading-relaxed">
          <p>
            ...
            <a href="https://therumpus.net" target="_blank" rel="noopener noreferrer"
              className="hover:opacity-70 transition-opacity">
              The Rumpus
            </a>{" "}
            whose work appears in{" "}
            <a href="https://www.14hills.net" target="_blank" rel="noopener noreferrer"
              className="hover:opacity-70 transition-opacity">
              14 Hills
            </a>.{" "}
            He is an alumnus of{" "}
            <a href="https://www.middlebury.edu/bread-loaf-conferences" target="_blank" rel="noopener noreferrer"
              className="hover:opacity-70 transition-opacity">
              Bread Loaf
            </a>,{" "}
            <a href="https://sewaneewriters.org" target="_blank" rel="noopener noreferrer"
              className="hover:opacity-70 transition-opacity">
              Sewanee
            </a>,{" "}
            <a href="https://tinhouse.com/writers-workshop" target="_blank" rel="noopener noreferrer"
              className="hover:opacity-70 transition-opacity">
              Tin House
            </a>,
            and{" "}
            <a href="https://www.kenyonreview.org/workshops" target="_blank" rel="noopener noreferrer"
              className="hover:opacity-70 transition-opacity">
              Kenyon
            </a>,
            and a resident of the{" "}
            <a href="https://vcca.com" target="_blank" rel="noopener noreferrer"
              className="hover:opacity-70 transition-opacity">
      ...
      <section className="grid grid-cols-1 md:grid-cols-[1fr_2fr] gap-6 md:gap-12 border-t border-black pt-8 pb-10">
        <h2 className="text-xl md:text-2xl font-black leading-tight">Published</h2>
        <a
